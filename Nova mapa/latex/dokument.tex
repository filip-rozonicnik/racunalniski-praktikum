...
\author{Beno Učakar}
\date{}
\posttitle{\par\large Reducirajoči podprostori \end{center}}
\begin{document}
\maketitle
...
Za nadaljnje branje priporočamo učbenik Sheldona Axlerja, \emph{Linear Algebra Done Right}~\cite{axler}.
