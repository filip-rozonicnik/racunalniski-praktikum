...
\begin{figure}[!ht]
   \centering
   \caption{Dürerjev magični kvadra}
   \label{fig:ime}
...
\begin{proof}
   ...
   $1+2+3+\dots+n^2=\sum_{Fk=1}^{n^2}k=\frac{1}{2}n^2(n^2+1)$. Ker imamo
...
\begin{table}
   ...
   \begin{tabular}{|l|c|c|c|c|c|c|}
         \multicolumn{5}{|c|}{točna vrednost}točna vrednost približek\\\hline
